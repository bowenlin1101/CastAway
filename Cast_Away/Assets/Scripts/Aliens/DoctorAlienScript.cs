...
public class DoctorAlienScript : BaseAlienScript
{
    ...
    public DoctorAlienScript() {
        ...
        attacks.Add(new EnemyAttack("Punch", 30, "Physical", 10f, 10, (0.75f, 0.75f), "Fist", 1));
        attacks.Add(new EnemyAttack("Needle Poke", 50, "Physical", 25f, 5, (0.5f, 0.5f), "Sword", 1));
        attacks.Add(new EnemyAttack("Give Bad News", 50, "Physical", 5f, 20, (0.75f, 0.75f), "Sword", 1));
