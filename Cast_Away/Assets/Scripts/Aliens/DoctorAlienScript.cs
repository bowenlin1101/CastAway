...
public class DoctorAlienScript : BaseAlienScript
{
    ...
    public DoctorAlienScript() {
        ...
        attacks.Add(new Attack("Punch", 30, "Physical", 10f, 10, 0.75f, "Fist", true));
        attacks.Add(new Attack("Needle Poke", 50, "Physical", 25f, 5, 0.5f, "Sword", true));
        attacks.Add(new Attack("Give Bad News", 50, "Physical", 5f, 20, 0.75f, "Sword", true));
